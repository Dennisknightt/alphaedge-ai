...
export const mockSystemState: SystemState = {
  ...
  monthlyDrawdown: 0.4,
  agentStatuses: [
    { id: 'a1', name: 'News Intelligence', type: 'NEWS', status: 'RUNNING', lastRun: new Date(Date.now() - 300000).toISOString(), itemsProcessed: 842, confidence: 8.2 },
    { id: 'a2', name: 'Macro Intelligence', type: 'MACRO', status: 'IDLE', lastRun: new Date(Date.now() - 3600000).toISOString(), itemsProcessed: 124, confidence: 7.8 },
    { id: 'a3', name: 'Social Intelligence', type: 'SOCIAL', status: 'RUNNING', lastRun: new Date(Date.now() - 120000).toISOString(), itemsProcessed: 2841, confidence: 6.4 },
    { id: 'a4', name: 'Prediction Market Agent', type: 'PREDICTION', status: 'RUNNING', lastRun: new Date(Date.now() - 180000).toISOString(), itemsProcessed: 38, confidence: 8.7 },
    { id: 'a5', name: 'Crypto Intelligence', type: 'CRYPTO', status: 'IDLE', lastRun: new Date(Date.now() - 900000).toISOString(), itemsProcessed: 500, confidence: 7.6 },
    { id: 'a6', name: 'Forex Intelligence', type: 'FOREX', status: 'IDLE', lastRun: new Date(Date.now() - 1800000).toISOString(), itemsProcessed: 62, confidence: 7.1 },
    { id: 'a7', name: 'Equity Intelligence', type: 'EQUITY', status: 'RUNNING', lastRun: new Date(Date.now() - 240000).toISOString(), itemsProcessed: 218, confidence: 7.9 },
    { id: 'a8', name: 'Risk & Capital Protection', type: 'RISK', status: 'RUNNING', lastRun: new Date(Date.now() - 60000).toISOString(), itemsProcessed: 31, confidence: 9.4 },
  ],
